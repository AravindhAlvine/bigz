...
export class ManageAttributeComponent implements OnInit {
  ...
  constructor(
    private manageCategoryService: ManageCateoriesService,
  ...
  getCategoriesWithSubCategories(filter) {
    this.manageCategoryService.getCategoriesWithSubcategories(this.searchCategoryText, filter).subscribe(result => {
  ...
  navigateToEditCategoryPage(category: getCategoriesWithSubcategoriesList) {
    this.router.navigate(['/manage-catalog/create-attribute']);
  ...
  updateSubCategoryAPICall(id: string, request: UpdateSubCategories) {
    this.manageCategoryService.updateSubCategoryById(id, request).subscribe(result => {
      this.getCategoriesWithSubCategories(this.filterItems);
    })
  }

  updateCategoryAPICall(id: string, request: UpdateCategory) {
    this.manageCategoryService.updateCategoryById(id, request).subscribe(result => {
      this.getCategoriesWithSubCategories(this.filterItems);
    })
  }
