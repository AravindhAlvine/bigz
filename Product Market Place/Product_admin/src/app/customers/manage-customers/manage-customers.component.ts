...
export class ManageCustomersComponent implements OnInit {
  ...
  filterItems: CustomerFilter = {} as CustomerFilter;
  ...
  ngOnInit(): void {
    ...
    this.getCustomerListAPICall(this.filterItems);
  }

  getCustomerListAPICall(filter) {
    this.customersService.getCustomerList(filter).subscribe(result => {
