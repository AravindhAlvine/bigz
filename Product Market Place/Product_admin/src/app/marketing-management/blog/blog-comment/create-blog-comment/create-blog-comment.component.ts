...
@Component({
  selector: 'app-create-blog-comment',
  templateUrl: './create-blog-comment.component.html',
  styleUrls: ['./create-blog-comment.component.scss']
})
export class CreateBlogCommentComponent implements OnInit {
